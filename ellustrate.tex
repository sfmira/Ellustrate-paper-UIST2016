...
\subsection{Study Design}
    ...
    \begin{itemize}
      \item \factor{Assistance (As)}: The tool helped my physical circuit [designing/fabricating] process.
    ...
    \end{itemize}
    In particular, \factor{ApT} describes the experience of designing a circuit with Ellustrate, while \factor{Ap} generalizes to how Ellustrate may serve as an educational tool.
