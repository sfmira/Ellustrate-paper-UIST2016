...
\subsection{Visual Analysis of Users' Designs}
  Participants' designs demonstrate how users balanced electrical requirements with aesthetic considerations. We extract some notable trends in how participants chose to navigate this constrained design space. We distinguished three types of lines that characterize how participants navigated around circuit rules to create their visual design, as detailed below: 
...
\subsection{Storytelling with Electronics}
  ...
  % , often in highly creative manners. For example, with the birthday cake-type designs, participants often saw the SVG in terms of both its aesthetic and its favorable ``branching-factor'' in terms of wiring.
...
\section{Observations and Insights}
  ...
  \subsection{Balance Between Visual Design, Electrical Routing, and Exisiting Mental Model}
  As Ellustrate was designed to facilitate the visual aesthetics of circuits, it was important to observe how users incoroporate electronic compoenents and traces into the background visual design. 
