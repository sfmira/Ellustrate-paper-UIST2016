...
\numberofauthors{1}
  ...
  % \alignauthor{}
     ...
     % \alignauthor{Joanne Lo$^{1,2}$, Cesar Torres$^{1,2}$, Isabel Yang$^{1}$, Jasper O'Leary$^{1}$, Danny Kaufman$^{2}$, Wilmot Li$^{2}$, Mira Dontcheva$^{2}$, Eric Paulos$^{1}$}
     % \and
     % \alignauthor{}
  }
...
%   % \alignauthor{}
%     \alignauthor{
%         \affaddr{$^1$Electrical Engineering and Computer Sciences}\\
%         \affaddr{ University of California, Berkeley}\\
%         \email{\{cearto, paulos\}@berkeley.edu}
%       }
%      \alignauthor{
%        \affaddr{$^2$Adobe Research}\\
%         \affaddr{601 Townsend St.}\\
