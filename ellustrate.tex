...
\subsection{Design objectives}
  ...
  To support these features, an Aesthetic Circuit design tool should ensure:
    \begin{itemize}
        ...
        \item {\bf Craft}: allow mechanical processes to interact with a ``material"  \danny{Why quotes on material?} such that the material exists in a ``continuum of [possible] states''\cite{mccullough1998abstracting}; and
        ...
        %Utilizing our modeled conductivity, we can provide users an idea of what type of resistance they should expect, as well as a simple countdown timer to aid in determining the necessary time for the conductive ink to dry.
            ...
            \begin{framed}
              ...
              \begin{enumerate}  
                  ...
                  \item Check resistance of positive trace $\approx$ 2X [calculated resistance]. If not, [dry, widen, continuity]. (\code{MULT})
                  \item Check resistance of negative trace $\approx$ 2X [calculated resistance]. If not, [dry, widen, continuity]. (\code{MULT})
