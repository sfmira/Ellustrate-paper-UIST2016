...
\subsubsection{Digital Sketching Tools} %These tools mainly want to make sense out of sketches
Since sketching is such an important element of early stage design, many digital tools have been created to facilitate this process. 




Since sketching is such an important elemtn of early stage circuit design, digital tool that aims to faciciliate this process has been extensively studied. Work in this area focuses mainly on generating a finalized circuit diagram from hand-drawn sketches by intelligently decomposing symobols for electrical components. 
\subsubsection{Digital Design Tools for Physical Designs}
1)microcontroller-enabled designs -> 2) physical designs on paper
